#
# GPIO-18-ON.py - This is a Python script designed to activate
# GPIO line 18, and enable ouput voltage on the pin. When 
# combined with GPIO-18-OFF.py, this script can be used to manually
# test a circuit configured to use GPIO line 18.
#
#------------------------------------------------------------------
# Change History
#------------------------------------------------------------------
